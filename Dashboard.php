<?php 
		session_start();
			...
			if(!isset($_SESSION['admin_id']))
			{
				...
				<?php
				header("refresh:0.5; url=signin&signup.php");
				exit();
			}
...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
		...
		<div style="position:absolute; top:0px; left:850px;">
		<?php echo"<br>Welcome " .$row["Name"]; ?>
		</div>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
			  ...
			  <?php $num_product = mysqli_query($connect, "SELECT * from product  ");	
					$product = mysqli_num_rows($num_product); ?>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
			  <?php $num_admin = mysqli_query($connect, "SELECT * from admin  ");	
					$admin = mysqli_num_rows($num_admin); ?>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
			  <?php $num_customer = mysqli_query($connect, "SELECT * from customer  ");	
					$customer = mysqli_num_rows($num_customer); ?>
        ...
        <div class="col-xl-3 col-sm-6">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
			  <?php $num_order = mysqli_query($connect, "SELECT * from order_details  ");	
					$order = mysqli_num_rows($num_order); ?>
	...
	<div style="text-align:center">
      ...
      <div class="row mt-4" >
        <div class="col-lg-4 col-md-6 mt-4 mb-4" style="position:absolute; left: 630px; width: 49%">
          <div class="card z-index-2" style="height: 350px">
        ...
        <div class="col-lg-4 col-md-6 mt-4 mb-4" style="width: 50%">
          <div class="card z-index-2" style="height: 350px">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
  ...
  <script>
    ...
    new Chart(ctx, {
      type: "bar",
      data: {
		 <?php $customer = mysqli_query($connect, "SELECT * from customer");	
		while($row=mysqli_fetch_assoc($customer))
		{
			?>
			labels: [<?php echo  $row['Customer_Id']; ?>],
			<?php
		}
		?>
