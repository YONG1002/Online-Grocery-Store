...
{
	$cusid=$_GET['id'];
	mysqli_query($connect,"UPDATE customer SET cus_isDelete=1 WHERE Customer_Id='$cusid'");
?>
	<script>
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
		...
		<li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="tablescustomer.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">table_view</i>
            </div>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
				...
				<h6 style="margin-left:85%;margin-top:-3%;"class="text-white text-capitalize ps-3"><a class="text-white text-capitalize ps-3" href="tablescustomer_recovery.php">Recovery Account</a></h6>
                ...
                <table class="table align-items-center mb-0">
				  ...
				  <tr>
                     <td class="align-middle text-center">
                      ...
                      <td class="align-middle text-center">
                        <a class="text-secondary font-weight-bold text-xs" href="tablescustomer.php?delete&id=<?php echo $row['Customer_Id'];?>" onclick="return confirmation()"> 
						Ban </a>
                      </td>
                    </tr>
                  </tbody>
