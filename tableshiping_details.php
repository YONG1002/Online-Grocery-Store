          ...
          <div class="card my-4">
            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
				...
				<a href="tableshiping.php" class="text-white text-capitalize ps-3">Back to Main</a>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
					  ...
					  <th style="color:black;text-align:center;text-center;">Shipping Address</th>
					  <th style="color:black;text-align:center;text-center;">Date</th>
					  <th style="color:black;text-align:center;text-center;">Order Id</th>
					  <th style="color:black;text-align:center;text-center;">Customer ID</th>
      ...
      <?php
        if(isset($_GET["searchbtn"]))
				{
					...
					$search=mysqli_query($connect,"SELECT * from shipping WHERE Date like '%$result%'");
                ...
                <tbody>
                     ...
                     <td style="color:black;text-align:center;text-center;">
                      ...
                      <td style="color:black;text-align:center;text-center;">
                        <?php echo  $row2['Shipping_Address']; ?>
                      </td>
                       <td style="color:black;text-align:center;text-center;">
                        <?php echo  $row2['Date']; ?>
                      </td>
				...
				else
        {
          if(isset($_GET["history"]))
					{
					$Customer_Id = $_GET["id"];				
					$result2 = mysqli_query($connect,"SELECT * from shipping WHERE Customer_Id='$Customer_Id'");
