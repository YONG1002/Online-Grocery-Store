  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
		...
		<li class="nav-item">
          <a class="nav-link text-white  active bg-gradient-primary " href="tablesorder.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Customer Order Details</li>
          </ol>
          <?php 
		$resultlogin = mysqli_query($connect,"SELECT * from admin WHERE admin_id='$admin_id'");
		$log=mysqli_fetch_assoc($resultlogin);
		?>
		<h6 class="font-weight-bolder mb-0" style="margin-left:400%;">
		<?php
		echo $log["Name"]; 
                ...
                <table class="table align-items-center mb-0">
				  ...
				  <tr>
                     <td class="align-middle text-center">
                      ...
                      <td class="align-middle text-center">
                        <a class="text-secondary font-weight-bold text-xs" href="order_history.php?history&id=<?php echo $row['Customer_Id'];?>" > 
						Check </a>
                      </td>
                    </tr>
                  </tbody>
